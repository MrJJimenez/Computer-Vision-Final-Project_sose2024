function [xx,yy,zz,color] = func(p1,p2,p3,p4,vp,image)
...
%  point 12;
%  vanish point
px_vertices2d = select_points(p1,p2,p3,p4,vp,image)
...
function coords = select_points(p1,p2,p7,p8,vpoint,image)
