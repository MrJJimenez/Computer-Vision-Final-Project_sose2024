function [pointCloud3d,pixels3D,vertices2d,f,px_h,px_w] = func(image,Rectangle,vpoint,obj)
...
%  point 12;
%  vanish point
px_vertices2d= select_points(image,Rectangle,vpoint);
...
function f = focal_length(px_coord2d)
    ...
    function coords = select_points(image,position,vpoint)
